...
const misteriosMap = {
    'Gozosos': ['Anunciação à Virgem Maria', 'Visita de Maria à sua prima Isabel', 'Nascimento de Nosso Senhor Jesus Cristo', 'Apresentação de Jesus no templo', 'Jesus, que é perdido e reencontrado entre os doutores'],
